...
class TabularData;
class AvailableAttributesModel;
class AvailableTransformsModel;

Q_DECLARE_OPAQUE_POINTER(const Graph*)
...
class Document : public QObject, public IDocument, public FailureReason
{
    ...
    Q_PROPERTY(GraphDisplay* graphDisplay MEMBER _graphDisplay NOTIFY graphDisplayChanged)
...
private:
    ...
    GraphDisplay* _graphDisplay = nullptr;
