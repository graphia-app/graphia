...
EnrichmentHeatmap::EnrichmentHeatmap(QQuickItem* parent) :
    ...
    _hoverLabel(new QCPItemText(&customPlot()))
{
    ...
    connect(this, &EnrichmentHeatmap::tableModelChanged, this, &EnrichmentHeatmap::buildPlot);

    connect(this, &QQuickPaintedItem::widthChanged, this, &EnrichmentHeatmap::horizontalRangeSizeChanged);
    connect(this, &QQuickPaintedItem::heightChanged, this, &EnrichmentHeatmap::verticalRangeSizeChanged);
    connect(this, &QQuickPaintedItem::widthChanged, this, &EnrichmentHeatmap::scaleXAxis);
    connect(this, &QQuickPaintedItem::heightChanged, this, &EnrichmentHeatmap::scaleYAxis);
}

void EnrichmentHeatmap::mousePressEvent(QMouseEvent* event)
{
...
void EnrichmentHeatmap::mouseReleaseEvent(QMouseEvent* event)
{
    routeMouseEvent(event);
    hideTooltip();
...
void EnrichmentHeatmap::mouseMoveEvent(QMouseEvent* event)
{
    routeMouseEvent(event);
}

void EnrichmentHeatmap::hoverMoveEvent(QHoverEvent *event)
{
...
void EnrichmentHeatmap::hoverLeaveEvent(QHoverEvent *event)
{
    hideTooltip();
    Q_UNUSED(event);
}

void EnrichmentHeatmap::buildPlot()
{
...
double EnrichmentHeatmap::columnAxisWidth()
{
...
double EnrichmentHeatmap::columnAxisHeight()
{
    const auto& margins = customPlot().axisRect()->margins();
...
void EnrichmentHeatmap::scaleXAxis()
{
...
void EnrichmentHeatmap::scaleYAxis()
{
...
void EnrichmentHeatmap::setElideLabelWidth(int elideLabelWidth)
{
...
void EnrichmentHeatmap::setXAxisLabel(const QString& xAxisLabel)
{
...
void EnrichmentHeatmap::setYAxisLabel(const QString& yAxisLabel)
{
...
void EnrichmentHeatmap::setScrollXAmount(double scrollAmount)
{
...
void EnrichmentHeatmap::setScrollYAmount(double scrollAmount)
{
...
double EnrichmentHeatmap::columnLabelSize()
{
    const QFontMetrics metrics(_defaultFont9Pt);
...
double EnrichmentHeatmap::horizontalRangeSize()
{
    return (columnAxisWidth() / (columnLabelSize() * _attributeACount));
}

double EnrichmentHeatmap::verticalRangeSize()
{
    return (columnAxisHeight() / (columnLabelSize() * _attributeBCount));
}

void EnrichmentHeatmap::showTooltip()
{
...
void EnrichmentHeatmap::savePlotImage(const QUrl& url, const QStringList& extensions)
{
...
void EnrichmentHeatmap::hideTooltip()
{
    _hoverLabel->setVisible(false);
    update();
}
