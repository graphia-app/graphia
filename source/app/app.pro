...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../thirdparty/release/ -lthirdparty
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../thirdparty/debug/ -lthirdparty
else:unix: LIBS += -L$$OUT_PWD/../thirdparty/ -lthirdparty

INCLUDEPATH += $$PWD/../thirdparty
DEPENDPATH += $$PWD/../thirdparty

win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../thirdparty/release/libthirdparty.a
else:win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../thirdparty/debug/libthirdparty.a
else:win32:!win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../thirdparty/release/thirdparty.lib
else:win32:!win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../thirdparty/debug/thirdparty.lib
else:unix: PRE_TARGETDEPS += $$OUT_PWD/../thirdparty/libthirdparty.a
