...
Attribute& Attribute::setIntMin(int intMin) { _intMin = intMin; return *this; }
Attribute& Attribute::setIntMax(int intMax) { _intMax = intMax; return *this; }
...
Attribute& Attribute::setFloatMin(double floatMin) { _floatMin = floatMin; return *this; }
Attribute& Attribute::setFloatMax(double floatMax) { _floatMax = floatMax; return *this; }
