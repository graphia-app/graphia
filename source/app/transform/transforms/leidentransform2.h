...
#ifndef LEIDENTRANSFORM2_H
#define LEIDENTRANSFORM2_H
...
class LeidenTransform2 : public GraphTransform
{
public:
    explicit LeidenTransform2(GraphModel* graphModel, bool weighted) :
...
class LeidenTransformFactory2 : public GraphTransformFactory
{
public:
    explicit LeidenTransformFactory2(GraphModel* graphModel) :
    ...
    {
        return std::make_unique<LeidenTransform2>(graphModel(), false);
    }
};

/*class WeightedLeidenTransformFactory2 : public LeidenTransformFactory
{
public:
