...
AdjacencyMatrixParser::AdjacencyMatrixParser(IUserNodeData* userNodeData,
...
void AdjacencyMatrixParser::addEdge(IGraphModel* graphModel,
...
bool AdjacencyMatrixParser::parseAdjacencyMatrix(const TabularData& tabularData, IGraphModel* graphModel)
{
    setProgress(-1);
...
bool AdjacencyMatrixParser::parseEdgeList(const TabularData& tabularData, IGraphModel* graphModel)
{
...
bool AdjacencyMatrixParser::parse(const QUrl& url, IGraphModel* graphModel)
{
...
QString AdjacencyMatrixParser::log() const
{
    QString text;
